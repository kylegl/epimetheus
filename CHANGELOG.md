...
- **Configurable recall timeout** — Added `recallTimeoutMs` (default 10000 ms, maximum 2147483647 ms) so slower Hindsight searches can use a longer deadline without changing the historical default.
